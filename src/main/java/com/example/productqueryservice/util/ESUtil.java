...
public class ESUtil {
    ...
    public static Query createMatchNameQuery(String query, int size, int page) {
        Query queryBuilder = Query.of(q -> q.match(m -> m.field("productName").query(query).boost(3.5F)));
